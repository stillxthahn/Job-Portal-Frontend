...
const InfoEmployer = () => {
    ...
    const [jobs, setJobs] = useState<Array<JobWithCompany>>(undefined)
    const [activeElement, setActiveElement] = useState(0);
    const [activeMap, setActiveMap] = useState<string>(undefined)
    useEffect(() => {
        ...
        <div className='bg-gray-100 mt-[66px] pb-4 '>
                ...
                <div className='container '>
                    <div className='flex container py-8'>
                        <div className='flex items-center justify-center md:gap-7 gap-3'>
                            <div className='w-[140px] sm:w-[160px] bg-white rounded-xl aspect-square overflow-hidden flex justify-center items-center'>
                                {company ? (
                                    <img className='' src={company?.logoUrl} alt="" />
                                ...
                                {company && (
                                    <>
                                        ...
                                        <div className='flex md:gap-3 gap-2 items-center font-semibold '>
                                            <div className='flex justify-center items-center w-[20px] md:w-[30px] aspect-square'>
            ...
            <div className='flex container my-10 gap-6  px-4 sm:px-0 flex-wrap md:flex-nowrap '>
                <div className='flex w-full flex-wrap gap-6 md:basis-2/3'>
                    <div className='flex flex-wrap w-full py-2 px-8 bg-white rounded-lg shadow-[0_8px_30px_rgb(0,0,0,0.12)]'>
