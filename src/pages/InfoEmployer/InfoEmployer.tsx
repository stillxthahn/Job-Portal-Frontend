            ...
            <div className='bg-gradient-to-r from-slate-900 to-red-900 text-gray-50'>
                <div className='hidden sm:flex container py-8'>
                    <div className='flex items-center justify-center gap-7'>
                        <div className='w-[140px] sm:w-[160px] bg-white rounded-xl aspect-square overflow-hidden flex justify-center items-center'><img className='' src={company?.imageUrl} alt="" /></div>
